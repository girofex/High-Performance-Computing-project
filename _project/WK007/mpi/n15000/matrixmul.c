...
int main(int argc, char **argv)
{
    ...
    /* Full b and c are needed on every rank (b is broadcast, c is gathered).
       a is only fully allocated on rank 0, which scatters it out. */
    ...
    //every process needs the whole of b
